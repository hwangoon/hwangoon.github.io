var App = {};
App.title = "내가 살게 될 지역";
App.desc = "내가 살게 될 지역은 어디일까요? 결과는 재미로 봐주세요 ^^";
App.thumbnail = "http://cfile236.uf.daum.net/image/217DA13F512AA8F01214E9";
App.input = '<input text="text" placeholder="이름을 입력해주세요." id="input-name" class="text-input" required="true">';
App.result = "%var1%님이 살게 될 지역은 %var2%입니다.";
